class DicodingClasses {
  final String title;
  final String description;

  DicodingClasses({required this.title, required this.description});

  final List<DicodingClasses> androidPath = [
    DicodingClasses(
  ...
  final List<DicodingClasses> iosPath = [
    DicodingClasses(
  ...
  final List<DicodingClasses> multiplatformPath = [
    DicodingClasses(
  ...
  final List<DicodingClasses> webPath = [
    DicodingClasses(
